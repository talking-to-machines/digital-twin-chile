...
INCLUDE_PROFILE_INFORMATION = True
INCLUDE_WEB_SEARCH = True
WEB_SEARCH_COUNTRY = "Chile"  #  TODO to be confirmed
...
POST_VOTING_PREFERENCE_PART1_INTERVIEW_FILE = (
    f"post_voting_preference_interview_part1_{PIPELINE_EXECUTION_DATE}.csv"
)
POST_VOTING_PREFERENCE_PART2_INTERVIEW_FILE = (
    f"post_voting_preference_interview_part2_{PIPELINE_EXECUTION_DATE}.csv"
)
